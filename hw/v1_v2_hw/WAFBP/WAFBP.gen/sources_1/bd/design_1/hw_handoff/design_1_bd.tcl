...
proc create_root_design { parentCell } {
  ...
  set buzzer_1 [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 buzzer_1 ]
  ...
  # Create ports
  set W_Echo_0 [ create_bd_port -dir I W_Echo_0 ]
  set W_Trig_0 [ create_bd_port -dir O W_Trig_0 ]
...
Reset#SD 0#UART 1#UART 1#GPIO#GPIO#Enet 0#Enet 0}\
  ...
  # Create instance: sonar_0, and set properties
  set sonar_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:sonar:1.0 sonar_0 ]
  ...
  connect_bd_intf_net -intf_net axi_gpio_2_GPIO [get_bd_intf_ports buzzer_1] [get_bd_intf_pins axi_gpio_2/GPIO]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI [get_bd_intf_pins ps7_0_axi_periph/M02_AXI] [get_bd_intf_pins sonar_0/S00_AXI]
  ...
  connect_bd_net -net W_Echo_0_1 [get_bd_ports W_Echo_0] [get_bd_pins sonar_0/W_Echo]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_gpio_1/s_axi_aclk] [get_bd_pins axi_gpio_2/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins ps7_0_axi_periph/M04_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk] [get_bd_pins sonar_0/W_Clk] [get_bd_pins sonar_0/s00_axi_aclk] [get_bd_pins vio_0/clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins axi_gpio_2/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/M04_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn] [get_bd_pins sonar_0/s00_axi_aresetn]
  connect_bd_net -net sonar_0_W_Distance_value [get_bd_pins sonar_0/W_Distance_value] [get_bd_pins vio_0/probe_in0]
  connect_bd_net -net sonar_0_W_Reading_done [get_bd_pins sonar_0/W_Enable] [get_bd_pins sonar_0/W_Next_sonar_status] [get_bd_pins sonar_0/W_Reading_done]
  connect_bd_net -net sonar_0_W_Trig [get_bd_ports W_Trig_0] [get_bd_pins sonar_0/W_Trig]
  ...
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs sonar_0/S00_AXI/S00_AXI_reg] -force
