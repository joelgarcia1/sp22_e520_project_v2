...
################################################################
# This is a generated script based on design: ov7670_blk_design
#
...
# source ov7670_blk_design_script.tcl
...
set design_name ov7670_blk_design
...
proc create_root_design { parentCell } {
  ...
  set ov7670_capture_0 [ create_bd_cell -type ip -vlnv user.org:user:ov7670_capture:1.0 ov7670_capture_0 ]
  ...
  set ov7670_vga_0 [ create_bd_cell -type ip -vlnv user.org:user:ov7670_vga:1.0 ov7670_vga_0 ]
...
1#unassigned#unassigned#Enet 0#Enet 0}\
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK2 [get_bd_ports AC_MCLK] [get_bd_pins processing_system7_0/FCLK_CLK2]
  ...
  connect_bd_net -net xlconcat_0_dout [get_bd_pins blk_mem_gen_0/clkb] [get_bd_pins ov7670_controller_0/clk] [get_bd_pins ov7670_vga_0/clk25] [get_bd_pins processing_system7_0/FCLK_CLK0]
